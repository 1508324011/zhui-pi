...
已有经验的站点会以 `references/site-patterns/{domain}.md` 形式存放。如需查看当前已经记录了哪些站点，请在 shell 中把 `workdir` 设为 `/home/zhurui/.config/opencode/skills/web-access/` 后运行：

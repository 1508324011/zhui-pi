...
Read the repository-owned workflow only when the current state requires process detail.
...
- **Active task status `in_progress`** → Phase 2 step 2.1 in `.trellis/workflow.md`.

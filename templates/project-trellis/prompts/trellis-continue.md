...
## Step 2: Load Workflow Detail When Needed

```bash
cat .trellis/workflow.md
```

The repository workflow defines the Plan / Execute / Finish routing and skill mapping.
...
## Step 4: Follow the Specific Step

Once you know which step to resume at, follow that section in `.trellis/workflow.md`. After each `[required]` step completes, move to the next.

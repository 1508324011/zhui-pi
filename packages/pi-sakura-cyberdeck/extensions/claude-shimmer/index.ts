 ...
 *
 * Same state machine as pi-claude-shimmer, recolored for synthwave:
...
const SAKURA: [number, number, number] = [255, 42, 109]; // #FF2A6D
const PEACH: [number, number, number] = [255, 160, 63];  // #FFA03F
const PETAL: [number, number, number] = [217, 119, 255];  // #D977FF
const LAVENDER: [number, number, number] = [167, 139, 250]; // #A78BFA
const SKY: [number, number, number] = [0, 240, 255];    // #00F0FF
const MINT: [number, number, number] = [110, 242, 200];   // #6EF2C8
...
export default function (pi: ExtensionAPI) {
   ...
   * Label + macaron color per tier (matches synthwave thinking* theme tokens).
   */
